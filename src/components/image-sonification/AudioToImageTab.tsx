...
interface AudioToImageTabProps {
  bulkState: BulkState
...
export function AudioToImageTab({
  bulkState,
  onFileChange,
  onBulkProcess,
  onBulkDownloadAll,
      ...
      <CardHeader>
        <div className="flex items-start justify-between gap-2">
          <div className="flex-1">
            ...
            <CardDescription>
              Upload one or multiple WAV files to reconstruct the original images
            </CardDescription>
          </div>
          <Tooltip>
            ...
            <TooltipContent className="max-w-xs">
              <p>
                Upload multiple audio files at once. The audio files contain encoded image data that can be decoded back to the original images.
              </p>
            </TooltipContent>
          </Tooltip>
        </div>
